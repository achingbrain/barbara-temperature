...
var SensorCheck = function() {
  ...
  this._slots = process.env.BARBARA_SLOTS || '/sys/devices/bone_capemgr.9/slots'
...
SensorCheck.prototype._loadOverlay = function(callback) {
  ...
  this._child_process.execFile('echo', ['BB-1WIRE-P9-22', '>', this._slots], function(error, stdout, stderr) {
    if(error) {
